(function (global, factory) {
	...
	(function () {
	  ...
	  function p(a) {
	    a = a.replace(ba, "").replace(ca, "");var b = da,
	        c = a,
	        e = new n();e.start = 0;e.end = c.length;for (var d = e, f = 0, h = c.length; f < h; f++) {
	      if ("{" === c[f]) {
	  ...
	  function la(a, b, c) {
	    c = void 0 === c ? "" : c;var e = "";if (a.cssText || a.rules) {
	      var d = a.rules,
	        ...
	        f = 0;for (var h = d.length, g; f < h && (g = d[f]); f++) {
	          e = la(g, b, e);
	        }
	  ...
	  var ka = 1,
	    ...
	    if (a) {
	      var d = !1,
	        ...
	        d = 0;f = a.length;for (var g; d < f && (g = a[d]); d++) {
	          A(g, b, c, e);
	        }
	      }
	    }
	  ...
	  function F(a) {
	    ...
	    var e = I;a.__styleScoped ? a.__styleScoped = null : Da(e, a, b || "", c);
	  }function Da(a, b, c, e) {
	    b.nodeType === Node.ELEMENT_NODE && Ea(b, c, e);if (b = "template" === b.localName ? (b.content || b.P).childNodes : b.children || b.childNodes) for (var d = 0; d < b.length; d++) {
	      Da(a, b[d], c, e);
	    }
	  }
	  function Ea(a, b, c) {
	    if (b) if (a.classList) c ? (a.classList.remove("style-scope"), a.classList.remove(b)) : (a.classList.add("style-scope"), a.classList.add(b));else if (a.getAttribute) {
	      var e = a.getAttribute(Fa);c ? e && (b = e.replace("style-scope", "").replace(b, ""), E(a, b)) : E(a, (e ? e + " " : "") + "style-scope " + b);
	    }
	  }function J(a, b, c) {
	    var e = I,
	        d = a.__cssBuild;t || "shady" === d ? b = z(b, c) : (a = F(a), b = Ga(e, b, a.is, a.s, c) + "\n\n");return b.trim();
	  }
	  function Ga(a, b, c, e, d) {
	    var f = K(c, e);c = c ? Ha + c : "";return z(b, function (b) {
	      b.c || (b.selector = b.g = L(a, b, a.b, c, f), b.c = !0);d && d(b, c, f);
	    });
	  }function K(a, b) {
	    return b ? "[is=" + a + "]" : a;
	  }function L(a, b, c, e, d) {
	    var f = b.selector.split(Ia);if (!Aa(b)) {
	  ...
	  G.prototype.b = function (a, b, c) {
	    var e = !1;a = a.trim();var d = M.test(a);d && (a = a.replace(M, function (a, b, c) {
	      return ":" + b + "(" + c.replace(/\s/g, "") + ")";
	    }), a = Ja(a));a = a.replace(Ka, N + " $1");a = a.replace(La, function (a, d, g) {
	      e || (a = Ma(g, d, b, c), e = e || a.stop, d = a.G, g = a.value);return d + g;
	    });d && (a = Ja(a));return a;
	  };
	  function Ma(a, b, c, e) {
	    var d = a.indexOf(Na);0 <= a.indexOf(N) ? a = Oa(a, e) : 0 !== d && (a = c ? Pa(a, c) : a);c = !1;0 <= d && (b = "", c = !0);if (c) {
	      var f = !0;c && (a = a.replace(Qa, function (a, b) {
	        return " > " + b;
	      }));
	    ...
	    a = a.split(Sa);a[0] += b;return a.join(Sa);
	  }
	  function Oa(a, b) {
	    var c = a.match(Ta);return (c = c && c[2].trim() || "") ? c[0].match(Ua) ? a.replace(Ta, function (a, c, f) {
	      return b + f;
	    }) : c.split(Ua)[0] === b ? c : Va : a.replace(N, b);
	  }function Wa(a) {
	    a.selector === Xa && (a.selector = "html");
	  }G.prototype.c = function (a) {
	    return a.match(Na) ? this.b(a, Ya) : Pa(a.trim(), Ya);
	  };aa.Object.defineProperties(G.prototype, { a: { configurable: !0, enumerable: !0, get: function get() {
	        return "style-scope";
	      } } });
	  var M = /:(nth[-\w]+)\(([^)]+)\)/,
	      Ya = ":not(.style-scope)",
	  ...
	  if (!t) {
	    ...
	    };if (window.customElements && !window.customElements.polyfillWrapFlushCallback) bb(document);else {
	      var cb = function cb() {
	        bb(document.body);
	      };window.HTMLImports ? window.HTMLImports.whenReady(cb) : requestAnimationFrame(function () {
	        if ("loading" === document.readyState) {
	          var a = function a() {
	            cb();document.removeEventListener("readystatechange", a);
	  ...
	  var db = Za;function P(a, b, c, e, d) {
	    this.j = a || null;this.b = b || null;this.A = c || [];this.o = null;this.s = d || "";this.a = this.h = this.m = null;
	  }function Q(a) {
	    ...
	    return this.j;
	  };P.prototype._getStyleRules = P.prototype.c;function fb(a) {
	  ...
	  }var gb = navigator.userAgent.match("Trident");function hb() {}function ib(a) {
	    var b = {},
	        c = [],
	        e = 0;A(a, function (a) {
	  ...
	  function T(a, b, c) {
	    b && (b = 0 <= b.indexOf(";") ? jb(a, b, c) : Ca(b, function (b, d, f, h) {
	  ...
	  function kb(a, b) {
	    var c = {},
	        e = [];A(a, function (a) {
	      a.f || R(a);var d = a.g || a.parsedSelector;b && a.f.i && d && fb.call(b, d) && (S(a, c), a = a.index, d = parseInt(a / 32, 10), e[d] = (e[d] || 0) | 1 << a % 32);
	    }, null, !0);return { i: c, key: e };
	  }
	  function lb(a, b, c, e, d) {
	    c.f || R(c);if (c.f.i) {
	      b = F(b);a = b.is;b = b.s;b = a ? K(a, b) : "html";var f = c.parsedSelector,
	          h = ":host > *" === f || "html" === f,
	          g = 0 === f.indexOf(":host") && !h;"shady" === e && (h = f === b + " > *." + b || -1 !== f.indexOf("html"), g = !h && 0 === f.indexOf(b));"shadow" === e && (h = ":host > *" === f || "html" === f, g = g && !h);if (h || g) e = b, g && (c.g || (c.g = L(I, c, I.b, a ? Ha + a : "", b)), e = c.g || b), d({ L: e, J: g, R: h });
	    }
	  }
	  function mb(a, b) {
	    var c = {},
	  ...
	  function nb(a, b, c, e) {
	    var d = F(b),
	        f = K(d.is, d.s),
	        h = new RegExp("(?:^|[^.#[:])" + (b.extends ? "\\" + f.slice(0, -1) + "\\]" : f) + "($|[.:[\\s>+~])");d = Q(b).j;var g = ob(d, e);return J(b, d, function (b) {
	      var d = "";b.f || R(b);b.f.cssText && (d = jb(a, b.f.cssText, c));b.cssText = d;if (!t && !Aa(b) && b.cssText) {
	        var k = d = b.cssText;null == b.B && (b.B = wa.test(d));if (b.B) if (null == b.v) {
	          b.v = [];for (var q in g) {
	            k = g[q], k = k(d), d !== k && (d = k, b.v.push(q));
	          }
	        } else {
	          for (q = 0; q < b.v.length; ++q) {
	            k = g[b.v[q]], d = k(d);
	          }k = d;
	        }b.cssText = k;b.g = b.g || b.selector;d = "." + e;q = b.g.split(",");
	        k = 0;for (var ub = q.length, O; k < ub && (O = q[k]); k++) {
	    ...
	    a = a.b;var c = {};if (!t && a) for (var e = 0, d = a[e]; e < a.length; d = a[++e]) {
	      var f = d,
	          h = b;f.l = new RegExp("\\b" + f.keyframesName + "(?!\\B|-)", "g");f.a = f.keyframesName + "-" + h;f.g = f.g || f.selector;f.selector = f.g.replace(f.keyframesName, f.a);c[d.keyframesName] = pb(d);
	    }return c;
	  }function pb(a) {
	    return function (b) {
	  ...
	  function qb(a, b) {
	    var c = U,
	      ...
	      var d = a.cssText = a.parsedCssText;a.f && a.f.cssText && (d = d.replace(ma, "").replace(na, ""), a.cssText = jb(c, d, b));
	    });
	  }aa.Object.defineProperties(hb.prototype, { a: { configurable: !0, enumerable: !0, get: function get() {
	        return "x-scope";
	      } } });var U = new hb();var rb = {},
	      V = window.customElements;if (V && !t) {
	    var sb = V.define;V.define = function (a, b, c) {
	      var e = document.createComment(" Shady DOM styles for " + a + " "),
	          d = document.head;d.insertBefore(e, (D ? D.nextSibling : null) || d.firstChild);D = e;rb[a] = e;sb.call(V, a, b, c);
	    };
	  }var W = new function () {
	    this.cache = {};this.a = 100;
	  }();function X() {
	    this.w = {};this.c = document.documentElement;var a = new n();a.rules = [];this.l = eb(this.c, new P(a));this.u = !1;this.b = this.a = null;
	  }l = X.prototype;l.D = function () {
	    db();
	  };l.H = function (a) {
	    return B(a);
	  };l.N = function (a) {
	  ...
	  l.prepareTemplate = function (a, b, c) {
	    if (!a.l) {
	      ...
	      }d = d.join("").trim();c = { is: b, extends: c, O: e };
	  ...
	  function tb(a) {
	    ...
	    !a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (a.a = window.ShadyCSS.ApplyShim, a.a.invalidCallback = ra);tb(a);
	  }
	  l.flushCustomStyles = function () {
	    Y(this);if (this.b) {
	      var a = this.b.processStyles();if (this.b.enqueued) {
	        ...
	        } else for (vb(this, this.c, this.l), b = 0; b < a.length; b++) {
	          (c = this.b.getStyleForCustomStyle(a[b])) && qb(c, this.l.m);
	        }this.b.enqueued = !1;this.u && !v && this.styleDocument();
	      }
	    }
	  };
	  l.styleElement = function (a, b) {
	    var c = F(a).is,
	        e = Q(a);if (!e) {
	      var d = F(a);e = d.is;d = d.s;var f = rb[e];e = m[e];if (e) {
	        var h = e._styleAst;var g = e.c;
	      }e = eb(a, new P(h, f, g, 0, d));
	    }a !== this.c && (this.u = !0);b && (e.o = e.o || {}, Object.assign(e.o, b));if (v) {
	      if (e.o) {
	        b = e.o;for (var k in b) {
	          null === k ? a.style.removeProperty(k) : a.style.setProperty(k, b[k]);
	        }
	      }if (((k = m[c]) || a === this.c) && k && k.a && !sa(k)) {
	        if (sa(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) Y(this), this.a && this.a.transformRules(k._styleAst, c), k.a.textContent = J(a, e.j), ta(k);t && (c = a.shadowRoot) && (c.querySelector("style").textContent = J(a, e.j));e.j = k._styleAst;
	      }
	    } else if (vb(this, a, e), e.A && e.A.length) {
	      c = e;k = F(a).is;a: {
	        if (b = W.cache[k]) for (h = b.length - 1; 0 <= h; h--) {
	          g = b[h];b: {
	            e = c.A;for (d = 0; d < e.length; d++) {
	  ...
	  l.styleSubtree = function (a, b) {
	    ...
	    var b = this,
	      ...
	      if (t) Wa(a);else {
	        var c = I;a.selector = a.parsedSelector;Wa(a);a.selector = a.g = L(c, a, c.c, void 0, void 0);
	      }v && (Y(b), b.a && b.a.transformRule(a));
	    });v ? a.textContent = z(c) : this.l.j.rules.push(c);
	  };
	  l.getComputedStyleValue = function (a, b) {
	    var c;v || (c = (Q(a) || Q(wb(this, a))).m[b]);return (c = c || window.getComputedStyle(a).getPropertyValue(b)) ? c.trim() : "";
	  };l.M = function (a, b) {
	    ...
	    }c && b.push(I.a, c);v || (c = Q(a)) && c.h && b.push(U.a, c.h);E(a, b.join(" "));
	  };l.F = function (a) {
	    return Q(a);
	  ...
	  X.prototype.flushCustomStyles = X.prototype.flushCustomStyles;Object.defineProperties(X.prototype, { nativeShadow: { get: function get() {
	        return t;
	      } }, nativeCss: { get: function get() {
	        return v;
	      } } });var Z = new X(),
	      xb,
	      yb;window.ShadyCSS && (xb = window.ShadyCSS.ApplyShim, yb = window.ShadyCSS.CustomStyleInterface);
	  window.ShadyCSS = { ScopingShim: Z, prepareTemplate: function prepareTemplate(a, b, c) {
	    ...
	    }, nativeCss: v, nativeShadow: t };xb && (window.ShadyCSS.ApplyShim = xb);
	...
	(function () {
	  ...
	  function p(a) {
	    a = a.replace(r, "").replace(aa, "");var c = t,
	        b = a,
	  ...
	  function t(a, c) {
	    var b = c.substring(a.start, a.end - 1);a.parsedCssText = a.cssText = b.trim();a.parent && (b = c.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), b = ba(b), b = b.replace(u, " "), b = b.substring(b.lastIndexOf(";") + 1), b = a.parsedSelector = a.selector = b.trim(), a.atRule = 0 === b.indexOf("@"), a.atRule ? 0 === b.indexOf("@media") ? a.type = v : b.match(ca) && (a.type = x, a.keyframesName = a.selector.split(u).pop()) : a.type = 0 === b.indexOf("--") ? y : z);if (b = a.rules) for (var d = 0, e = b.length, f; d < e && (f = b[d]); d++) {
	      t(f, c);
	    }return a;
	  }
	  function ba(a) {
	  ...
	  var z = 1,
	      ...
	      ha = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,
	      ca = /^@[^\s]*keyframes/,
	      u = /\s+/g;var ia = Promise.resolve();function ja(a) {
	    ...
	    a._applyShimValidatingVersion = a._applyShimNextVersion;a.b || (a.b = !0, ia.then(function () {
	      a._applyShimCurrentVersion = a._applyShimNextVersion;a.b = !1;
	    }));
	  ...
	  }window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss ? D = window.ShadyCSS.nativeCss : window.ShadyCSS ? (F(window.ShadyCSS), window.ShadyCSS = void 0) : F(window.WebComponents && window.WebComponents.flags);var G = D;var H = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
	      I = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,
	      la = /@media\s(.*)/;var J = new Set();function K(a) {
	    if (!a) return "";"string" === typeof a && (a = p(a));return A(a, G);
	  }function L(a) {
	    !a.__cssRules && a.textContent && (a.__cssRules = p(a.textContent));return a.__cssRules || null;
	  }function M(a, c, b, d) {
	    if (a) {
	      ...
	      }f === z ? c(a) : b && f === x ? b(a) : f === y && (e = !0);if ((a = a.rules) && !e) {
	  ...
	  function N(a, c) {
	    ...
	    }d = a.substring(b + 4, e);b = a.substring(0, b);a = N(a.substring(e + 1), c);e = d.indexOf(",");return -1 === e ? c(b, d.trim(), "", a) : c(b, d.substring(0, e).trim(), d.substring(e + 1).trim(), a);
	  }var ma = /;\s*/m,
	    ...
	    a = I.test(a) || H.test(a);I.lastIndex = 0;H.lastIndex = 0;return a;
	  };
	  R.prototype.m = function (a, c) {
	    if (void 0 === a.a) {
	      var b = [];for (var d = a.content.querySelectorAll("style"), e = 0; e < d.length; e++) {
	        var f = d[e];if (f.hasAttribute("shady-unscoped")) {
	          if (!C) {
	            var h = f.textContent;J.has(h) || (J.add(h), h = f.cloneNode(!0), document.head.appendChild(h));f.parentNode.removeChild(f);
	          }
	    ...
	    c = void 0 === c ? "" : c;var b = L(a);this.l(b, c);a.textContent = K(b);return b;
	  };R.prototype.f = function (a) {
	    var c = this,
	        b = L(a);M(b, function (a) {
	      ":root" === a.selector && (a.selector = "html");c.g(a);
	    });a.textContent = K(b);return b;
	  };R.prototype.l = function (a, c) {
	    var b = this;this.c = c;M(a, function (a) {
	      b.g(a);
	    });this.c = null;
	  ...
	  function S(a, c) {
	    for (var b; b = I.exec(c);) {
	      var d = b[0],
	          e = b[1];b = b.index;var f = c.slice(0, b + d.indexOf("@apply"));c = c.slice(b + d.length);var h = T(a, f);d = void 0;var g = a;e = e.replace(ma, "");var m = [];var l = g.a.get(e);l || (g.a.set(e, {}), l = g.a.get(e));if (l) {
	        g.c && (l.i[g.c] = !0);var q = l.h;for (d in q) {
	          g = h && h[d], l = [d, ": var(", e, "_-_", d], g && l.push(",", g.replace(O, "")), l.push(")"), O.test(q[d]) && l.push(" !important"), m.push(l.join(""));
	        }
	      }d = m.join("; ");c = "" + f + d + c;I.lastIndex = b + d.length;
	    }return c;
	  }
	  function T(a, c) {
	    c = c.split(";");for (var b, d, e = {}, f = 0, h; f < c.length; f++) {
	      if (b = c[f]) if (h = b.split(":"), 1 < h.length) {
	        b = h[0].trim();var g = a;d = b;h = h.slice(1).join(":");var m = na.exec(h);m && (m[1] ? (g.b || (g.b = document.createElement("meta"), g.b.setAttribute("apply-shim-measure", ""), g.b.style.all = "initial", document.head.appendChild(g.b)), d = window.getComputedStyle(g.b).getPropertyValue(d)) : d = "apply-shim-inherit", h = d);d = h;e[b] = d;
	      }
	    }return e;
	  }function qa(a, c) {
	    if (Q) for (var b in c.i) {
	      b !== a.c && Q(b);
	    }
	  }
	  function pa(a, c, b, d, e) {
	    d && N(d, function (c, b) {
	      b && a.a.get(b) && (e = "@apply " + b + ";");
	        ...
	        w,
	        X = !1;for (w in g) {
	      var E = f[w];void 0 === E && (E = "initial");!l || w in l || (X = !0);q.push("" + b + "_-_" + w + ": " + E);
	    }X && qa(a, m);m && (m.h = g);d && (h = c + ";" + h);return "" + h + q.join("; ") + ";";
	  }R.prototype.detectMixin = R.prototype.o;R.prototype.transformStyle = R.prototype.j;
	  R.prototype.transformCustomStyle = R.prototype.f;R.prototype.transformRules = R.prototype.l;R.prototype.transformRule = R.prototype.g;R.prototype.transformTemplate = R.prototype.m;R.prototype._separator = "_-_";Object.defineProperty(R.prototype, "invalidCallback", { get: function get() {
	      return Q;
	    }, set: function set(a) {
	      Q = a;
	    } });var U = new R();function V() {
	    this.a = null;U.invalidCallback = ja;
	  }function W(a) {
	    ...
	    W(this);k[c] = a;c = U.m(a, c);a._styleAst = c;
	  };
	  ...
	  V.prototype.styleElement = function (a) {
	    W(this);var c = a.localName,
	        b;c ? -1 < c.indexOf("-") ? b = c : b = a.getAttribute && a.getAttribute("is") || "" : b = a.is;if ((c = k[b]) && !B(c)) {
	      if (B(c) || c._applyShimValidatingVersion !== c._applyShimNextVersion) this.prepareTemplate(c, b), ka(c);if (a = a.shadowRoot) if (a = a.querySelector("style")) a.__cssRules = c._styleAst, a.textContent = K(c._styleAst);
	    }
	  ...
	  if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
	    var Y = new V(),
	        Z = window.ShadyCSS && window.ShadyCSS.CustomStyleInterface;window.ShadyCSS = { prepareTemplate: function prepareTemplate(a, c) {
	        ...
	        Y.flushCustomStyles();
	      }, nativeCss: G, nativeShadow: C };Z && (window.ShadyCSS.CustomStyleInterface = Z);
	...
	(function () {
	  var c = !(window.ShadyDOM && window.ShadyDOM.inUse),
	    ...
	    requestAnimationFrame(function () {
	      ...
	      r = null;function t() {
	    this.customStyles = [];this.enqueued = !1;p(function () {
	  ...
	  t.prototype.a = function () {
	    for (var a = this.customStyles, b = 0; b < a.length; b++) {
	      var d = a[b];if (!d.__shadyCSSCachedStyle) {
	        var e = this.b(d);e && (e = e.__appliedElement || e, q && q(e), d.__shadyCSSCachedStyle = e);
	      }
	    }return a;
	  ...
	  Object.defineProperties(t.prototype, { transformCallback: { get: function get() {
	    ...
	    }, flushCustomStyles: function flushCustomStyles() {}, nativeCss: h, nativeShadow: c });window.ShadyCSS.CustomStyleInterface = v;
	}).call(undefined);

	(function () {
	  var templateId = "cp-theme";

	  if (document.getElementById(templateId)) {
	    return;
	  }

	  var cpthemeTemplate = document.createElement("div");
